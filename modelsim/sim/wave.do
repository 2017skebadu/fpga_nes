...
add wave -noupdate -format Literal -radix hexadecimal P6502_RAM_tb/duv/wram_blk/addr_a
add wave -noupdate -format Literal -radix hexadecimal P6502_RAM_tb/duv/wram_blk/din_a
add wave -noupdate -format Literal -radix hexadecimal P6502_RAM_tb/duv/wram_blk/dout_a
add wave -noupdate -format Literal -radix hexadecimal P6502_RAM_tb/duv/wram_blk/ram
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {118 ns} 0}
